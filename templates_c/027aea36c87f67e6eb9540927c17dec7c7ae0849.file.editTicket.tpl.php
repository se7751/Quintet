<?php /* Smarty version Smarty-3.0.8, created on 2014-10-25 15:49:31
         compiled from "view/editTicket.tpl" */ ?>
<?php /*%%SmartyHeaderCode:3464544baa6b75b5f4-16334243%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '027aea36c87f67e6eb9540927c17dec7c7ae0849' => 
    array (
      0 => 'view/editTicket.tpl',
      1 => 1414244946,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '3464544baa6b75b5f4-16334243',
  'function' => 
  array (
  ),
...
">チケット作成</a></li>
	...
	<body></br>
		...
		<input type="hidden" name="choose"/>
			<!-- コメントテーブルに格納する投稿ID -->
			<input type="hidden" name="id" value="<?php echo $_smarty_tpl->getVariable('ticket_id')->value;?>
" />
			<table id="nyuryoku"><?php  $_smarty_tpl->tpl_vars['tic'] = new Smarty_Variable;
...
?>
					<tr>
						<th>タイトル</th>
						<td><input type="text" name="title" id="title" value="<?php echo $_smarty_tpl->tpl_vars['tic']->value['title'];?>
" /></td>
					</tr>
					<tr>
						<th>ステータス</th>
						<td>
							<select name="state">
                            <option value="新規"><?php echo $_smarty_tpl->tpl_vars['tic']->value['state'];?>
</option>
                            <option value="">-----</option>
						...
						<td>
                            ...
                            <option value="新規"><?php echo $_smarty_tpl->tpl_vars['tic']->value['category'];?>
</option>
                            <option value="">-----</option>
					...
					<tr>
						...
						<td>
                            ...
                            <option value="新規"><?php echo $_smarty_tpl->tpl_vars['tic']->value['priority'];?>
</option>
                            <option value="">-----</option>
					...
					<tr>
						<th>期日</th>
						<td>
							<input type="text" name="kijitu" id="date" size="10" value="<?php echo $_smarty_tpl->tpl_vars['tic']->value['kijitu'];?>
" />
					...
					<tr>
						<th>詳細</th>
						<td><textarea name="body" id="body" cols="40" rows="8"><?php echo $_smarty_tpl->tpl_vars['tic']->value['body'];?>
</textarea></td>
					</tr>
					...
					<tr>
                        ...
                        <?php }else{ ?>
                            <td><a href="view/<?php echo $_smarty_tpl->tpl_vars['tic']->value['file_name'];?>
" class="user active"><?php echo $_smarty_tpl->tpl_vars['tic']->value['file_name'];?>
</a>
                            <a href="#" class="delete" onclick="del_confirm('delete.php?ticket_id=<?php echo $_smarty_tpl->tpl_vars['tic']->value['ticket_id'];?>
